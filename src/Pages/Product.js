...
const Products = [
  ...
  },
  {
    ...
    price: '100',
    img:
      'https://www.bing.com/th?id=OIP.rx4Ijpkxn3-qN6VcANpllAHaFu&w=284&h=219&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2',
  },
  {
    id: '3',
    name: 'coke',
    price: '50',
    img:
      'https://www.bing.com/th?id=OIP.-kWWoyiuaA2sTWdp3j7dfAHaMb&w=192&h=323&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2',
  },
  {
    id: '4',
    name: 'pepsi',
    price: '50',
    img:
      'https://www.bing.com/th?id=OIP.V3E7k9pW3gsW81I3iNBz8gHaKR&w=212&h=294&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2',
  },
]
              ...
              <div className="col-md-4 p-2" key={item.id}>
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <button
                      onClick={() =>
                        addItem(item.id, item.name, item.price, item.img)
                      }
